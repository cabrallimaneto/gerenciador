class UserController {
  ...
  onEdit() {
    ...
    this.formUpdateEl.addEventListener("submit", (event) => {
      ...
      // assign - copia o valor de atributos de um objeto retornando um novo
  ...
  getPhoto(formEl) {
    return new Promise((resolve, reject) => {
      //API nativa para ler arquivos e pastas no js.
  ...
  //percorrendo o formmulario e pegando os valores
  getValues(formEl) {
    let user = {};
    let isValid = true;
  ...
  addLine(dataUser) {
    ...
    let tr = this.getTr(dataUser);
            //adiciona uma nova linha na tabela(novo usuario)
